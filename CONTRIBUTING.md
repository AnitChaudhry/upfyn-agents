...
Thanks for your interest in contributing to Upfyn-Code! Before you start, please take a moment to read through this guide.

## Before You Start

- **Search first.** Check [existing issues](https://github.com/AnitChaudhry/UpfynAI-Code/issues) and [pull requests](https://github.com/AnitChaudhry/UpfynAI-Code/pulls) to avoid duplicating work.
- **Discuss first** for new features. Open an [issue](https://github.com/AnitChaudhry/UpfynAI-Code/issues/new) to discuss your idea before investing time in implementation. We may already have plans or opinions on how it should work.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/<your-username>/UpfynAI-Code.git
   cd UpfynAI-Code
   ```
